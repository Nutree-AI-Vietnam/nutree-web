  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        title: 'Contact',
        body: [
          `Payment support: ${LEGAL_COMPANY.email}. See also the [Cancellation & Refund policy](/cancellation).`,
        ],
      },
    ],
  },
  vi: {
    ...
    sections: [
      ...
      },
      {
        title: 'Liên hệ',
        body: [
          `Hỗ trợ thanh toán: ${LEGAL_COMPANY.email}. Xem thêm [Chính sách hủy & hoàn tiền](/cancellation).`,
        ],
      },
    ],
  },
